    ...
    <body>
        ...
        <main class="mx-auto w-[75%] ">
            <div class=" flex flex-collumn justify-center h-screen items-center">
                ...
                <form class=" p-4 bg-blue-300 " action="{{ route('login') }}" method="POST">
                    ...
                    <div class="p-8 text-center">
                      ...
                      <p class="text-gray-700">dont have an account? Make one right now!</p>
                         <a class="text-gray-600" href="{{ route('register') }}">Register</a>
                </form>
